...
import com.example.readyreadingkotlin.questions.fragments.CheckBoxesFragment;
import com.example.readyreadingkotlin.questions.fragments.RadioBoxesFragment;
    ...
    private void parsingData(Bundle bundle)
    {
        ...
        for (int i = 0; i < questionsItems.size(); i++)
        {
          ...
          /*  if (question.getQuestionTypeName().equals("Radio"))
            {
                RadioBoxesFragment radioBoxesFragment = new RadioBoxesFragment(thi);
