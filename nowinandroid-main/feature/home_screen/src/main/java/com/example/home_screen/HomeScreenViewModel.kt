...
import com.example.sights_list.R
import com.google.samples.apps.nowinandroid.core.domain.sights.AddSightsUseCase
...
class HomeScreenViewModel @Inject constructor(
    ...
    private val addSightsUseCase: AddSightsUseCase,
    ...
    val sampleSights = listOf(
        Sight(
            id = "1",
            imageResId = com.example.sights_list.R.drawable.colosseum, // Replace with actual drawable
            name = "Colosseum",
        ...
        Sight(
            id = "2",
            imageResId = com.example.sights_list.R.drawable.central_park, // Replace with actual drawable
            name = "Central Park",
        ...
        Sight(
            id = "3",
            imageResId = com.example.sights_list.R.drawable.vietnam_memorial, // Replace with actual drawable
        ...
        Sight(
            id = "4",
            imageResId = com.example.sights_list.R.drawable.berlin_wall, // Replace with actual drawable
        ...
        Sight(
            id = "5",
            imageResId = com.example.sights_list.R.drawable.eiffel_tower, // Replace with actual drawable
            name = "Eiffel Tower",
        ...
        Sight(
            id = "6",
            imageResId = com.example.sights_list.R.drawable.hyde_park, // Replace with actual drawable
            name = "Hyde Park",
