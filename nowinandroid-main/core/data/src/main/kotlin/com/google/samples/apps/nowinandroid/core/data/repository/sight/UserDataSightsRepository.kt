...
interface UserDataSightsRepository {

    /**
     * Gets the bookmarked sights ids as a stream
     */
    fun getBookmarkedSightsIds(): Flow<Set<String>>
    ...
    /**
     * Updates the visited status for a sight
     */
