...
import com.google.samples.apps.nowinandroid.core.data.repository.sight.CompositeUserSightsRepository
import com.google.samples.apps.nowinandroid.core.data.repository.sight.DefaultSightsRepository
import com.google.samples.apps.nowinandroid.core.data.repository.sight.DefaultUserDataSightsRepository
import com.google.samples.apps.nowinandroid.core.data.repository.sight.SightsRepository
import com.google.samples.apps.nowinandroid.core.data.repository.sight.UserDataSightsRepository
...
abstract class DataModule {
    ...
    @Binds
    internal abstract fun bindsSightsRepository(
        sightsRepository: DefaultSightsRepository,
    ): SightsRepository

    @Binds
    internal abstract fun bindsUserDataSightsRepository(
        userDataSightsRepository: DefaultUserDataSightsRepository,
    ): UserDataSightsRepository

    @Binds
    internal abstract fun bindsUserSightsRepository(
        userSightsRepository: CompositeUserSightsRepository,
